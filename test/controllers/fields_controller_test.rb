...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { description: @field.description, name: @field.name } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { description: @field.description, name: @field.name } }
